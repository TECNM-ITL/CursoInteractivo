...
const Highlight := preload("res://addons/godot-course/overlays/highlight/highlight.gd")
const Dimmer := preload("res://addons/godot-course/overlays/dimmer/dimmer.gd")
const EditorInterfaceAccess := preload("res://addons/godot-course/editor_interface_access.gd")
const Utils := preload("res://addons/godot-course/utils.gd")
...
func _init(interface: EditorInterfaceAccess) -> void:
	...
	_highlight_style_scaled = load("res://addons/godot-course/overlays/highlight/highlight.tres").duplicate(true)
